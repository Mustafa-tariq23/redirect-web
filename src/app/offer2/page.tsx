...
function Offer2Content() {
    ...
    useEffect(() => {
        const handleBackButtonSetup = () => {
            ...
            const handlePopState = () => {
                // When back button is pressed, go to offer3
                window.location.href = '/offer3';
            };
    ...
    return (
        <div 
            ...
            className="min-h-screen bg-gradient-to-br from-green-500 to-teal-600 flex items-center justify-center p-4 cursor-pointer"
        >
